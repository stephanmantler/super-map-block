...
export const settings = {
	...
	icon: {
			...
			>
				<g id="Layer_1_1_">
					<polygon
						...
						stroke="#888"
						strokeWidth="10"
						points="226.8,201.3 173.7,211.1 120.5,204.9 67.3,211.1 14.2,201.3 27.5,148.2 14.2,95 27.5,41.8 80.6,51.6 
		133.8,45.4 187,51.6 240.1,41.8 226.8,95 240.1,148.2 	"
					...
					<polygon
						...
						fill="none"
						strokeWidth="1.5"
						points="27.7,41.9 80.6,51.6 133.8,45.4 186.6,51.8 240.1,41.8 226.8,95 240.1,148.2 227.2,201.5 173.7,211.1 
				...
				<g id="Layer_2_1_">
					<g>
						<polygon
							...
							stroke="#000"
							strokeWidth="1.65"
							points="16.8,92.3 41.6,55 213.5,55 238.4,92.3 127.6,203.1 		"
						/>
						<path
							stroke="#000"
							strokeWidth="3"
							d="M210,61.7l19.8,29.8L127.4,193.8L25,91.4l19.8-29.8h82.4H210 M217.1,48.4h-89.5H37.9L8.2,93.2l119.4,119.4L247,93.2
			L217.1,48.4L217.1,48.4z"
					...
					<g>
						<path
							...
							stroke="#000"
							strokeWidth="10"
							d="M76.3,151.3l19-22.7c11.6,8.8,24.8,12.4,37.2,12.4c6.5,0,9.1-1.7,9.1-4.6v-0.2c0-3-3.3-4.8-14.7-6.9
	...
	edit: withSelect( ( select ) => {
		...
		if (
			window.stepmanMapboxAccessToken !== undefined &&
			window.stepmanMapboxAccessToken.length > 0
		) {
		...
		const controls = [
			<InspectorControls key="stepman_map_controls">
				...
				<PanelBody
					title={ __( 'Data / Overlays', 'super-map-block' ) }
					initialOpen={ false }
				>
					<PanelRow>
						<ToggleControl
							label={ __(
								'show post annotation shapes',
								'super-map-block'
							) }
	...
	save: ( props ) => {
		...
		return (
			<MapComponent
				...
				customOverlayAttribution={
					props.attributes.customOverlayAttribution
				}
			/>
		);
	},
